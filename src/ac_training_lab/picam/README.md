...
2. Orient the camera ribbon cable so that the metal contacts face the connector on the Pi.
3. Carefully insert the ribbon cable fully into the camera connector.
